...
class PlayState extends MusicBeatState
{
	...
	override public function create()
	{
		...
		switch (curStage)
		{
			...
			case 'alley':
				...
				var shadow1:FlxSprite = new FlxSprite(645, 685);
				shadow1.loadGraphic(Paths.image('shadow'));
				shadow1.scale.set(0.71, 1);
				shadow1.alpha = 0.4;

				var shadow2:FlxSprite = new FlxSprite(985, 805);
				shadow2.loadGraphic(Paths.image('shadow'));
				shadow2.scale.set(1, 1);
				shadow2.alpha = 0.3;

				var shadow3:FlxSprite = new FlxSprite(155, 805);
				shadow3.loadGraphic(Paths.image('shadow'));
				shadow3.scale.set(1, 1);
				shadow3.alpha = 0.3;
			...
			case 'snow':
				...
				precacheList.set('backgrounds/snow/dark', 'image');
				precacheList.set('backgrounds/snow/floorfront', 'image');
				precacheList.set('backgrounds/snow/floorback', 'image');
				precacheList.set('backgrounds/snow/mountains', 'image');
				precacheList.set('backgrounds/snow/sky', 'image');
		}
		...
		fx = new FlxSprite(0, 0); 
		fx.frames = Paths.getJSONAtlas('fx');
		fx.animation.addByPrefix('idle','idle',24);
		fx.animation.play('idle');
		fx.screenCenter(X);
		fx.screenCenter(Y);
		fx.scale.set(3, 3);
		...
		add(vignette);
		precacheList.set('blackvignette', 'image');
		...
		curse = new FlxSprite();
		curse.makeGraphic(FlxG.width, FlxG.height, 0xFF000000, true);
		curse.screenCenter(X);
		curse.screenCenter(Y);
		curse.scale.set(1.20, 1.20);
		curse.alpha = 0.001;
		add(curse);
	...
	override function beatHit()
	{
		...
		if(curSong.toLowerCase() == 'acupuncture' && songMisses >= 0 && curBeat >= 299)
		{	
			trace(curBeat);
		}
